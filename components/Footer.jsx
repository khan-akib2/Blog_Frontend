...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full overflow-hidden bg-white dark:bg-[#060b18] text-gray-600 dark:text-gray-300">
      {/* Top gradient line */}
      ...
      <div className="relative mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12 mb-14">
          ...
          <div className="md:col-span-4">
            <Link href="/" className="inline-flex items-center gap-3 mb-5 group">
              ...
              <div className="flex flex-col leading-none">
                <span className="text-lg font-black text-gray-900 dark:text-white tracking-tight">
                  Blog<span className="text-blue-500 dark:text-blue-400">Hub</span>
                </span>
                <span className="text-[9px] font-semibold tracking-[0.15em] uppercase text-gray-400 dark:text-gray-500">by NIT</span>
              </div>
            </Link>
            <p className="text-sm leading-relaxed text-gray-500 dark:text-gray-400 max-w-xs mb-6">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {['Next.js', 'Node.js', 'MongoDB'].map((tech) => (
                <span key={tech} className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-semibold text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-[#1a2744] bg-gray-50 dark:bg-[#0d1526]">
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                <a key={label} href={href} aria-label={label}
                  className="flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 dark:border-[#1a2744] bg-gray-50 dark:bg-[#0d1526] text-gray-500 dark:text-gray-400 hover:border-blue-500/50 hover:text-blue-500 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/30 transition-all duration-200">
          ...
          <div className="md:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              <h3 className="mb-4 text-xs font-bold uppercase tracking-[0.12em] text-gray-400 dark:text-gray-500">Platform</h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={href}>
                    <Link href={href}
                      className="group inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors duration-200">
                      {label}
            ...
            <div>
              <h3 className="mb-4 text-xs font-bold uppercase tracking-[0.12em] text-gray-400 dark:text-gray-500">Writers</h3>
              <ul className="space-y-3">
                {[
                  ['Start Writing', '/write'],
                  ['Dashboard', '/dashboard'],
        ...
        {/* Newsletter strip */}
        <div className="rounded-2xl border border-blue-100 dark:border-[#1a2744] p-6 mb-10 relative overflow-hidden"
          ...
          <div className="relative flex flex-col sm:flex-row items-center justify-between gap-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Get the best articles delivered to your inbox weekly.</p>
              </div>
            </div>

            {subscribed ? (
              <div className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-green-600 dark:text-green-400"
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2 w-full sm:w-auto" suppressHydrationWarning>
                <input
                  ...
                  required
                  className="flex-1 sm:w-52 px-4 py-2.5 rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-[rgba(6,11,24,0.8)] border border-gray-300 dark:border-[#1a2744] focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none transition-all"
        ...
        {/* Bottom bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-gray-200 dark:border-[#1a2744] pt-8">
          ...
          <div className="flex items-center gap-6">
            {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map((item) => (
              <a key={item} href="#" className="text-xs text-gray-500 hover:text-gray-900 dark:hover:text-gray-300 transition-colors">{item}</a>
            ))}
          </div>
